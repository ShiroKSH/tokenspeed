...
# windows reproduced at large decode batches). The CuTe DSL kernel in
# ops/attention/cute_dsl/kda_fused_decode.py is the fused decode path
# (cluster-synchronized window commit); platforms without CuTe DSL take
# the unfused conv/recurrence chain. The verify megafusion below writes
